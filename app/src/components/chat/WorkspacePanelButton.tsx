...
export function WorkspacePanelButton({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-[#2a2f39] bg-[#0c0f15]/90 text-[#8891a1] transition-all duration-200 hover:border-[#384151] hover:bg-[#10141d] hover:text-[#e2e8f0] active:scale-95 disabled:opacity-40"
